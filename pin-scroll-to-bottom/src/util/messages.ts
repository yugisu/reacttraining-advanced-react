...
*/
import MP from 'static/avatars/MP.png'
import EI from 'static/avatars/EI.png'
import TG from 'static/avatars/TG.png'
import GC from 'static/avatars/GC.png'

import { TMessage } from 'types/message.type'

const AVATARS: Record<string, string> = { MP, EI, TG, GC }

const SCRIPT: TMessage[] = [
...
const subscribeToMessages = (cb: (message: TMessage) => void) => {
  SCRIPT.slice(0)
    .map((message) => {
